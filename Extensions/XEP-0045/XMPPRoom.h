...
- (void)xmppRoom:(XMPPRoom *)sender occupantKicked:(XMPPJID *)occupantJID withReason:(NSString*)reason;
- (void)xmppRoom:(XMPPRoom *)sender kickedWithReason:(NSString*)reason;
- (void)xmppRoom:(XMPPRoom *)sender occupantBanned:(XMPPJID *)occupantJID withReason:(NSString*)reason;
- (void)xmppRoom:(XMPPRoom *)sender bannedWithReason:(NSString*)reason;
- (void)xmppRoomMembershipRevoked:(XMPPRoom *)sender;
